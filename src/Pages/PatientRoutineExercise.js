...
/** Esta Pagina son el listado de ejercicios dentro de una rutina de un paciente especifico 
...
const PatientRoutineExcercise = () => {
  const currentUser = useContext(UserContext);
  return (
    <>
      <Header title='Paciente' icon={<PersonIcon />} />
...
export default PatientRoutineExcercise;
